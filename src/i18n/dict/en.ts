...
export const en: Record<TKey, string> = {
  ...
  'tama.playsHint': 'Playing (taps + drags) evolves your pet — 100 → stage 2, 300 → stage 3, 500 → the coloured stage 4! At stage 4 you can also give it a name.',
