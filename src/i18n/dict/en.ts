...
export const en: Record<TKey, string> = {
  ...
  'homewidget.desc': 'Links your timetable to this phone’s home-screen widget. Once linked, the widget follows every change you make.',
  'homewidget.step1': 'Connect the timetable with the button below',
  'homewidget.step2': 'Long-press your home screen → Widgets → 24Houring',
  'homewidget.step3': 'Tap the widget to open the app',
