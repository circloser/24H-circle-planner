...
export const en: Record<TKey, string> = {
  ...
  'marketing.menu': 'News emails',
  'marketing.title': 'Get news by email?',
  'marketing.body': 'May we email you about new 24Houring features and events? It is optional, and every feature works the same if you say no.',
