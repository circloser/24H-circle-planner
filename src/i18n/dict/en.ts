...
export const en: Record<TKey, string> = {
  ...
  'decor.trayHint': 'Pick a sticker, then tap days to stick it on',
  'decor.trayArmed': '{glyph} picked — tap a day to stick it',
  'decor.title': 'Decorate',
  'decor.addSticker': 'Add sticker',
  'decor.remove': 'Peel off sticker',
  'decor.full': 'Up to {n} stickers per day',
  'decor.highlight': 'Highlighter',
  'decor.none': 'None',
  'decor.proBody': 'Decorating days with stickers and highlighters is a Pro feature.',
