...
export const en: Record<TKey, string> = {
  ...
  'e2ee.menu': 'End-to-end encryption',
  'e2ee.enableTitle': 'Turn on end-to-end encryption',
  'e2ee.enableBody': 'Lock the data stored in the cloud with a passphrase on this device. No one — including the operator — will be able to read it.',
  'e2ee.enableAction': 'Enable encryption',
  'e2ee.warnNoRecovery': 'This passphrase cannot be recovered. If you forget it, no one (including the operator) can restore the data stored in the cloud. Keep it somewhere safe.',
  ...
  'e2ee.ackLose': 'I understand that if I forget the passphrase, the cloud data cannot be recovered.',
  'e2ee.enabled': 'End-to-end encryption is on',
  'e2ee.unlockTitle': 'Unlock encrypted data',
  'e2ee.unlockBody': "This device's cloud data is locked with a passphrase. Enter the passphrase you set.",
  'e2ee.unlockAction': 'Unlock',
  'e2ee.unlocked': 'Unlocked',
  'e2ee.errorWrong': 'Incorrect passphrase.',
  'e2ee.errorGeneric': 'Something went wrong.',
  'e2ee.manageTitle': 'End-to-end encryption',
  'e2ee.manageBody': "This device's cloud sync is protected by end-to-end encryption.",
  'e2ee.activeHere': 'Encryption is active on this device.',
  'e2ee.forgetHere': 'Forget passphrase on this device',
  'e2ee.forgetHint': 'Clears the stored passphrase on this device; you will re-enter it on the next sync. (Cloud data is kept.)',
  'e2ee.forgotten': 'Passphrase forgotten on this device',
  'e2ee.disableAction': 'Turn off encryption (revert cloud to plaintext)',
  'e2ee.disableHint': 'Stores the cloud data as plaintext again. The operator will be able to read it afterwards.',
  'e2ee.disabled': 'End-to-end encryption is off',
  'goals.open': 'Goals',
  'goals.title': 'Goals',
