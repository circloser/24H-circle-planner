...
export const en: Record<TKey, string> = {
  ...
  'tutorial.s2': 'Click a slice to open its editor, then use the delete button to remove it. (Don’t worry — undo brings it back.)',
  'tutorial.s3': 'Click a slice to open its editor and rename it to an activity of yours.',
  'tutorial.s4': 'Click just outside the ring, near the highlight, to stick a note on that time of day. Try adding one.',
  'tutorial.s5': 'Open the highlighted Diary menu and save today from “Diary”. Saved days feed your analytics later.',
