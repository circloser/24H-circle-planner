...
export const en: Record<TKey, string> = {
  ...
  'magician.open': '✨ Decorate with the Design Magician',
  'magician.next': 'Next',
  ...
  'tutorial.open': '📚 Take the tutorial',
  'tutorial.title': 'Timetable tutorial',
  'tutorial.s1': 'Resize a block — drag a slice’s edge to make it longer or shorter.',
  'tutorial.s2': 'Delete a line — double-click a slice to open its editor and remove it.',
  'tutorial.s3': 'Rename an item — click a slice to change its label.',
  'tutorial.s4': 'Rim memo — click just outside the ring to add a note on the border.',
  'tutorial.s5': 'Save a diary — save today from the Diary menu.',
  'tutorial.s6': 'Switch views — tap 24h · 12h · Table to change the view.',
