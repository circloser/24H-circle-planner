...
export const ko = {
  ...
  'decor.stickers': '스티커',
  'decor.trayHint': '스티커를 고른 뒤 날짜를 누르면 붙어요',
  'decor.trayArmed': '{glyph} 선택됨 — 붙일 날짜를 누르세요',
  'decor.title': '꾸미기',
  'decor.addSticker': '스티커 추가',
  'decor.remove': '스티커 떼기',
  'decor.full': '하루에 스티커는 {n}개까지 붙일 수 있어요',
  'decor.highlight': '형광펜',
  'decor.none': '없음',
  'decor.proBody': '스티커·형광펜으로 날짜를 꾸미는 다꾸는 Pro 기능이에요.',
  'decor.groupMood': '기분',
