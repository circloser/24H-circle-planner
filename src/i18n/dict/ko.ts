...
export const ko = {
  ...
  'homewidget.desc': '이 폰의 홈 화면 위젯에 시간표를 연결합니다. 한 번 연결하면 시간표를 바꿀 때마다 위젯이 자동으로 따라와요.',
  'homewidget.step1': '아래 버튼으로 시간표를 위젯에 연결',
  'homewidget.step2': '홈 화면을 길게 눌러 위젯 → 24Houring 추가',
  'homewidget.step3': '위젯을 탭하면 앱이 열려요',
