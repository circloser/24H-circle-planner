...
export const ko = {
  ...
  'tutorial.open': '📚 튜토리얼 체험',
  'tutorial.title': '시간표 튜토리얼',
  'tutorial.s1': '시간표 크기 조정 — 조각의 경계선을 드래그해 시간을 늘리거나 줄여보세요.',
  'tutorial.s2': '라인 삭제 — 조각을 두 번 눌러 편집 창을 열고 삭제할 수 있어요.',
  'tutorial.s3': '항목명 수정 — 조각을 눌러 이름을 바꿔보세요.',
  'tutorial.s4': '테두리 메모 — 원 바깥 테두리를 눌러 메모를 추가해보세요.',
  'tutorial.s5': '일기 저장 — ‘일기’ 메뉴에서 오늘 하루를 저장하세요.',
  'tutorial.s6': '화면 전환 — 24시간 · 12시간 · 표 보기를 눌러 전환해보세요.',
