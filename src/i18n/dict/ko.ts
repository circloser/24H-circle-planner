...
export const ko = {
  ...
  'tutorial.s2': '조각을 클릭하면 편집 창이 열려요. 창 안의 삭제 버튼으로 이 조각을 지워보세요. (걱정 마세요 — 되돌리기로 복구할 수 있어요.)',
  'tutorial.s3': '조각을 클릭해 편집 창을 열고, 이름을 원하는 활동으로 바꿔 저장해보세요.',
  'tutorial.s4': '원 바깥, 하이라이트된 부근을 클릭하면 그 시간대에 포스트잇처럼 메모를 붙일 수 있어요. 하나 적어보세요.',
  'tutorial.s5': '위 하이라이트된 일기 메뉴를 열고 ‘일기’에서 오늘 하루를 저장해보세요. 저장한 날은 나중에 분석에 쓰여요.',
