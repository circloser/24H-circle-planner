...
export const ko = {
  ...
  'e2ee.menu': '종단간 암호화',
  'e2ee.enableTitle': '종단간 암호화 켜기',
  'e2ee.enableBody': '클라우드에 저장되는 데이터를 이 기기에서 암호로 잠급니다. 운영자를 포함해 아무도 내용을 볼 수 없게 됩니다.',
  'e2ee.enableAction': '암호화 켜기',
  'e2ee.warnNoRecovery': '이 암호는 복구할 수 없습니다. 잊어버리면 클라우드에 저장된 데이터를 누구도(운영자 포함) 되살릴 수 없습니다. 안전한 곳에 보관하세요.',
  ...
  'e2ee.ackLose': '암호를 잊으면 클라우드 데이터를 복구할 수 없음을 이해했습니다.',
  'e2ee.enabled': '종단간 암호화를 켰습니다',
  'e2ee.unlockTitle': '암호화된 데이터 잠금 해제',
  'e2ee.unlockBody': '이 기기의 클라우드 데이터는 암호로 잠겨 있습니다. 설정한 암호를 입력하세요.',
  'e2ee.unlockAction': '잠금 해제',
  'e2ee.unlocked': '잠금이 해제되었습니다',
  'e2ee.errorWrong': '암호가 올바르지 않습니다.',
  'e2ee.errorGeneric': '처리 중 오류가 발생했습니다.',
  'e2ee.manageTitle': '종단간 암호화',
  'e2ee.manageBody': '이 기기의 클라우드 동기화는 종단간 암호화로 보호되고 있습니다.',
  'e2ee.activeHere': '이 기기에서 암호화가 활성화되어 있습니다.',
  'e2ee.forgetHere': '이 기기에서 암호 잊기',
  'e2ee.forgetHint': '이 기기에서 저장된 암호를 지웁니다. 다음 동기화 시 다시 입력해야 합니다. (클라우드 데이터는 그대로 유지)',
  'e2ee.forgotten': '이 기기에서 암호를 잊었습니다',
  'e2ee.disableAction': '암호화 끄기 (클라우드 평문 전환)',
  'e2ee.disableHint': '클라우드 데이터를 다시 평문으로 저장합니다. 이후 운영자가 내용을 볼 수 있게 됩니다.',
  'e2ee.disabled': '종단간 암호화를 껐습니다',
  'goals.open': '목표',
  'goals.title': '목표',
