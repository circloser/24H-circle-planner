...
import { RelationToggle } from '@/components/ChartViewToggle/RelationToggle';
import { PlaceToggle } from '@/components/ChartViewToggle/PlaceToggle';
...
export function AppHeader({
  ...
  return (
    ...
    >
      <div className="container mx-auto grid min-h-14 grid-cols-[minmax(0,1fr)_auto] items-center gap-1.5 px-3 py-2 sm:h-14 sm:grid-cols-[1fr_auto_1fr] sm:gap-2 sm:px-4 sm:py-0">
