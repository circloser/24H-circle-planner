...
export default {
  ...
  mainHtml: `      <main style="max-width:760px;margin:0 auto;padding:40px 20px;font-family:'Pretendard',system-ui,-apple-system,'Segoe UI',Arial,sans-serif;color:#1f2430;line-height:1.65">
        ...
        <nav class="copy-actions"><a href="/templates/">時間割テンプレート</a><a href="/calendar">月の予定を立ててデコする</a><a href="/guides/">使い方ガイド</a></nav>
        <details><summary>月の予定を立てて手帳のようにデコする</summary>
          <p>上部の<strong>カレンダー</strong>を押すと2か月が並んで表示されます。終日・時間指定の予定を入れ、日付をドラッグして複数日の予定を作り、繰り返しを設定しましょう。Pro では Google カレンダーの予定も読み取り専用で表示できます。</p><p><strong>デザイン → カレンダーをデコ</strong>でカラーテーマを選び、Pro では紙・ステッカー・マスキングテープ・写真ステッカーでデコできます。貼ったものは画面サイズが変わっても同じ日の上に残ります。<strong>書き出し</strong>で月を 2160px の画像として保存できます。<a href="/calendar">カレンダーの紹介を見る</a></p>
        </details>
