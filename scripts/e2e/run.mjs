...
const SUITES = ['smoke', 'diary', 'goals', 'memo', 'export', 'settings', 'layout', 'calendar', 'ical', 'decor', 'ga', 'intro', 'share', 'widget', 'mailing', 'weather', 'clocks', 'e2ee', 'sync', 'widgetpos', 'weekday', 'mobile'];
